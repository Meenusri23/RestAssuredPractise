...
import complexJsonDeserialization.Movies;
import complexJsonDeserialization.OtherDetails;
import complexJsonDeserialization.SuperHeroMoviesAndSeries;
import complexJsonDeserialization.TvSeries;

public class SerializerLombok {
...
SuperHeroMoviesAndSeries moviesAndSeries = new SuperHeroMoviesAndSeries();
		...
		File Json = new File("Complexjson1.json");
		
		//moviesAndSeries - this complete object will be written to Complexjson1 file
